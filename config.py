...
def config():
    ...
    # Data
    parser.add_argument('--csv_path', type=str, default="/kaggle/input/extracting-attributes-from-fashion-images-jan-2024/train.csv", help='Dataframe for labels and image names')
